<?php
namespace TargetQodef\Modules\Shortcodes\UnorderedList;
...
class UnorderedList implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		if($font_weight!==''){
			$list_style .= 'font-weight: ' . $font_weight .';';
		}
		$content = preg_replace('#^<\/p>|<p>$#', '', $content);
        $html = '<div class="qodef-unordered-list '.$list_item_classes.'" '.  target_qodef_get_inline_style($list_style).'>'.do_shortcode($content).'</div>';
        return $html;
	}
}
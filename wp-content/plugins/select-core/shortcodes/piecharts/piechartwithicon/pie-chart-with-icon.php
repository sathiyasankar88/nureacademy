<?php
namespace TargetQodef\Modules\Shortcodes\PieCharts\PieChartWithIcon;
...
class PieChartWithIcon implements ShortcodeInterface {
			...
			'params' => array_merge(
				...
				array(
					array(
						...
						'dependency' => Array('element' => 'icon_pack', 'value' => target_qodef_icon_collections()->getIconCollectionsKeys()),
						'group' => esc_html__('Design Options', 'select-core')
					),
					array(
						'type' => 'textfield',
	...
	private function getPieChartIcon($params) {
		...
		$pie_chart_icon = target_qodef_icon_collections()->renderIcon( $params[$icon], $params['icon_pack'], $iconStyles );

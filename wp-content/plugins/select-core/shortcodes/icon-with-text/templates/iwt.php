<div <?php target_qodef_class_attribute($holder_classes); ?>  <?php target_qodef_inline_style($holder_parameters); ?>>
    ...
    <div class="qodef-iwt-content-holder" <?php target_qodef_inline_style($content_styles); ?>>
        ...
        <div class="qodef-iwt-text-holder">
            ...
            <?php if(!empty($link) && !empty($link_text)) : ?>
                <a itemprop="url" class="qodef-iwt-link" href="<?php echo esc_attr($link); ?>" <?php target_qodef_inline_attr($target, 'target'); ?>><?php echo esc_html($link_text); ?></a>
            <?php endif; ?>
        </div>

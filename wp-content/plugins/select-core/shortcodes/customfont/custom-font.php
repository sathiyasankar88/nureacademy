<?php
namespace TargetQodef\Modules\Shortcodes\CustomFont;
		...
		vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						"value" => target_qodef_get_font_style_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
						...
						"value" => target_qodef_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => target_qodef_get_text_transform_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
						...
						"value" => array(
							esc_html__("None", "targetwp") => "",
							esc_html__("Underline", "targetwp") => "underline",
							esc_html__("Overline", "targetwp") => "overline",
							esc_html__("Line Through", "targetwp") => "line-through"
						),
						"description" => ""
					),
					array(
					...
					array(
						...
						"value" => array(
							...
							esc_html__("Justify", "targetwp") => "justify"
						),
						"description" => ""
					),
					array(
						"type" => "textarea",
						"heading" => esc_html__("Content", "targetwp"),
						"param_name" => "content_custom_font",
						"value" => esc_html__("Custom Font Content", "targetwp"),
						"description" => "",
						"save_always" => true
					)
				)

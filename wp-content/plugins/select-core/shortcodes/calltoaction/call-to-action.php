<?php
namespace TargetQodef\Modules\Shortcodes\CallToAction;
...
class CallToAction implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		$call_to_action_button_IconCollections = target_qodef_icon_collections()->iconCollections;
		...
		vc_map( array(
				...
				'params' => array_merge(
					...
					target_qodef_icon_collections()->getVCParamsArray(array('element' => 'type', 'value' => array('with-icon'))),
					array(
						array(
							'type' 			=> 'textfield',
						...
						array(
							...
							'value' => array_merge(array('No Icon' => ''),target_qodef_icon_collections()->getIconCollectionsVC()),
							'save_always' => true,
							'dependency' => array('element' => 'show_button', 'value' => array('yes'))
						)
					),
	...
	public function render($atts, $content = null) {
		...
		foreach (target_qodef_icon_collections()->iconCollections as $collection_key => $collection) {

			$call_to_action_icons_form_fields['button_' . $collection->param ] = '';

		}

		$args = array_merge($args, target_qodef_icon_collections()->getShortcodeParams(),$call_to_action_icons_form_fields);
	...
	private function getCallToActionIcon($params) {
		...
		if(!empty($params[$icon])){			
			$call_to_action_icon = target_qodef_icon_collections()->renderIcon( $params[$icon], $params['icon_pack'], $iconStyles );
		}
	...
	private function getButtonParameters($params) {
		...
		if(!empty($params['button_icon_pack'])) {
			...
			$iconPackName = target_qodef_icon_collections()->getIconCollectionParamNameByKey($params['button_icon_pack']);

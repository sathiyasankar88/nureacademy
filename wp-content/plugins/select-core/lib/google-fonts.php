<?php
if ( ! function_exists( 'target_qodef_init_google_fonts_array' ) ) {
    function target_qodef_init_google_fonts_array() {
        ...
        $target_qodef_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'target_qodef_init_google_fonts_array');
}
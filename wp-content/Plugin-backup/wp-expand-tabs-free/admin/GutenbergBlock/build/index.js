...
const icons = {};
icons.sptabfreeIcon = el('img', {
  src: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_0__.escapeAttribute)(sp_tab_free_gb_block.url + 'admin/GutenbergBlock/assets/wp-tabs-icon.svg')
});
...
const DynamicShortcodeInput = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, el('div', {
    className: 'sptabfree-gutenberg-shortcode editor-styles-wrapper'
  }, el('select', {
    className: 'sptabfree-shortcode-selector',
  ...
  }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_1__.escapeHTML)(__('-- Select a tabs group --', 'wp-expand-tabs-free'))), shortCodeList.map(shortcode => {
...
registerBlockType("sp-wp-tabs-free/shortcode", {
  title: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("WP Tabs", "wp-expand-tabs-free")),
  description: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Use WP Tabs to insert a tabs group in your page", "wp-expand-tabs-free")),
  icon: _shortcode_blockIcon__WEBPACK_IMPORTED_MODULE_1__["default"].sptabfreeIcon,
  category: "common",
  supports: {
    html: true
  },
  edit: props => {
    ...
    if (attributes.preview) {
      return el('div', {
        className: 'sptabfree_shortcode_block_preview_image'
      }, el('img', {
        src: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeAttribute)(sp_tab_free_gb_block.url + "admin/GutenbergBlock/assets/wp-tabs-block-preview.svg")
      }));
    }
    ...
    if (shortCodeList.length === 0) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, el('div', {
        ...
        src: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeAttribute)(sp_tab_free_gb_block.url + "admin/GutenbergBlock/assets/wp-tabs-icon.svg")
      }), (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("WP Tabs", "wp-expand-tabs-free"))), el('div', {
        className: 'components-placeholder__instructions'
      }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("No shortcode found. ", "wp-expand-tabs-free")), el('a', {
        href: (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeAttribute)(sp_tab_free_gb_block.link)
      }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Create a shortcode now!", "wp-expand-tabs-free"))))));
    }
    ...
    if (!attributes.shortcode || attributes.shortcode == 0) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
        ...
        className: 'components-placeholder__instructions'
      }, (0,_wordpress_escape_html__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(__("Select a tabs group", "wp-expand-tabs-free"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_shortcode_dynamicShortcode__WEBPACK_IMPORTED_MODULE_2__["default"], {
        attributes: attributes,
        shortCodeList: shortCodeList,
        shortcodeUpdate: shortcodeUpdate
      })));
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
      ...
      block: "sp-wp-tabs-free/shortcode",
      attributes: attributes
    }));
  },

<?php
/*
Plugin Name: Wonder 3D Carousel Pro
...
define('WONDERPLUGIN_3DCAROUSEL_VERSION', '4.2C');
...
define('WONDERPLUGIN_3DCAROUSEL_PLUGIN_VERSION', '4.2');
...
class WonderPlugin_3DCarousel_Plugin {
	...
	function register_menu()
	{
		...
		$menu = add_menu_page(
				__('Wonder 3D Carousel Pro', 'wonderplugin_3dcarousel'),
				__('Wonder 3D Carousel Pro', 'wonderplugin_3dcarousel'),
				$userrole,
		...
		$menu = add_submenu_page(
				'wonderplugin_3dcarousel_overview',
				__('Register', 'wonderplugin_3dcarousel'),
				__('Register', 'wonderplugin_3dcarousel'),
				'manage_options',
				'wonderplugin_3dcarousel_register',
				array($this, 'register' ) );
		add_action( 'admin_print_styles-' . $menu, array($this, 'enqueue_admin_script') );
...
define('WONDERPLUGIN_3DCAROUSEL_VERSION_TYPE', 'C');

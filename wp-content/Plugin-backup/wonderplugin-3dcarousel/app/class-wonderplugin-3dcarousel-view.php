...
class WonderPlugin_3DCarousel_View {
	...
	function print_overview() {
		...
		<h2><?php echo __( 'Wonder 3D Carousel', 'wonderplugin_3dcarousel' ) . ( (WONDERPLUGIN_3DCAROUSEL_VERSION_TYPE == "C") ? " Pro" : ( (WONDERPLUGIN_3DCAROUSEL_VERSION_TYPE == "L") ? " Lite" : " Trial" ) ) . " Version " . WONDERPLUGIN_3DCAROUSEL_VERSION; ?> </h2>
	...
	function print_register() {
		...
		function validateLicenseForm() {
			...
			if (jQuery.trim(jQuery("#wonderplugin-3dcarousel-key").val()).length <= 0)
			{
	...
	?>
		...
		<h2><?php _e( 'Tools', 'wonderplugin_3dcarousel' ); ?></h2>
		...
		<ul class="wonderplugin-tab-buttons-horizontal" id="wp-tools-toolbar" data-panelsid="wonderplugin-popup-display-panels">
			...
			<li class="wonderplugin-tab-button-horizontal"><span class="dashicons dashicons-desktop" style="margin-right:8px;"></span><?php _e( 'PHP Info', 'wonderplugin_3dcarousel' ); ?></li>
		</ul>

 ...
 */
if (!class_exists('Everest_Tab_Widget')) {

    class Everest_Tab_Widget extends WP_Widget {

        public function __construct() {
            parent::__construct('Everest_Tab_Widget', 'Everest Tabs Widget', array('description' => __('Display Specific tab with its specific configuration post.', ETAB_TD)));
        }
        ...
        public function widget($args, $instance) {
            ...
            $etab_id = isset($instance['etab_id']) ? $instance['etab_id'] : '';
        ...
        public function form($instance) {
            ...
            $id = isset($instance['etab_id']) ? $instance['etab_id'] : '';
            ?>
            <p>
                <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', ETAB_TD); ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>"/>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('etab_id'); ?>"><?php _e('Select Post Tab:', ETAB_TD); ?></label>

...
registerBlockType( 'et-display-block/et-widget', {
	title: __( 'Everest Tab' ), // Block title.
	...
	edit(props){
		...
		return createElement('div', {}, [
			...
			createElement( serverSideRender, {
				block: 'et-display-block/et-widget',
			...
			createElement( InspectorControls, {},
				...
				createElement(SelectControl, {
					value: [props.attributes.et_id],
					label: __( 'Everest Tab' ),
					onChange: changeEtId,
					options: etab,
				}),
				]

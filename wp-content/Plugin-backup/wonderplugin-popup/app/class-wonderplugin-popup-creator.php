				...
				<li class="wonderplugin-tab wonderplugin-tab-vertical">
					...
					<table class="wonderplugin-form-table-options">
						...
						<tr>
							...
							<td><input name="wonderplugin-popup-ga4account" type="text" id="wonderplugin-popup-ga4account" placeholder="G-XXXXXXXXXX" value="<?php echo $config['ga4account']; ?>" class="wonderplugin-popup-option regular-text" /></td>
						</tr>

						<tr>
							<th>Google Universal Analytics ID</th>
							<td><input name="wonderplugin-popup-gaid" type="text" id="wonderplugin-popup-gaid" placeholder="UA-XXXXXXXX-Y" value="<?php echo $config['gaid']; ?>" class="wonderplugin-popup-option regular-text" /></td>
						</tr>

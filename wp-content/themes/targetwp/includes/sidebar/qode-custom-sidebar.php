...
if ( ! class_exists( 'TargetQodefSidebar' ) ) {

	class TargetQodefSidebar {
		...
		function __construct() {
			...
			$this->title  = esc_html__( 'Custom Widget Area', 'targetwp' );
		...
		function load_assets() {
			...
			wp_enqueue_script( 'target-qodef-sidebar', QODE_ROOT . '/framework/admin/assets/js/qodef-sidebar.js' );
			wp_enqueue_style( 'target-qodef-sidebar', QODE_ROOT . '/framework/admin/assets/css/qodef-sidebar.css' );
		}
		...
		function template_add_widget_field() {
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_html__( 'Enter Name of the new Widget Area', 'targetwp' ) . "' name='qode-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='" . esc_html__( 'Add Widget Area', 'targetwp' ) . "' />";
			echo "\n    " . $nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars() {
			...
			$args = apply_filters( 'target_qodef_custom_widget_args', $args );

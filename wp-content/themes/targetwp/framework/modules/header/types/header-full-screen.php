...
class HeaderFullScreen extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = target_qodef_filter_px(target_qodef_options()->getOptionValue('menu_area_height_header_full_screen'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['menu_area_in_grid'] = target_qodef_get_meta_field_intersect('menu_area_in_grid_header_full_screen') == 'yes' ? true : false;

        $parameters = apply_filters('target_qodef_header_full_screen_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } elseif(target_qodef_options()->getOptionValue('menu_area_background_color_header_full_screen') == '') {
            $menuAreaTransparent = target_qodef_options()->getOptionValue('menu_area_grid_background_color_header_full_screen') !== '' &&
                target_qodef_options()->getOptionValue('menu_area_grid_background_transparency_header_full_screen') !== '1';
        } else {
            $menuAreaTransparent = target_qodef_options()->getOptionValue('menu_area_background_color_header_full_screen') !== '' &&
                target_qodef_options()->getOptionValue('menu_area_background_transparency_header_full_screen') !== '1';
        }
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'qodef_menu_area_background_color_header_full_screen_meta', true) !== ''){
            ...
            $menuAreaTransparent = target_qodef_options()->getOptionValue('menu_area_grid_background_color_header_full_screen') !== '' &&
                target_qodef_options()->getOptionValue('menu_area_grid_background_transparency_header_full_screen') === '0';
        } else {
            $menuAreaTransparent = target_qodef_options()->getOptionValue('menu_area_background_color_header_full_screen') !== '' &&
                target_qodef_options()->getOptionValue('menu_area_background_transparency_header_full_screen') === '0';
        }

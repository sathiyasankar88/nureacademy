...
use TargetQodef\Modules\Header\Types;
/**
...
class HeaderFactory {
    ...
    public function validHeaderObject($header_object = null) {
        ...
        return is_subclass_of($header_object, 'TargetQodef\Modules\Header\Lib\HeaderType');
    }
        ...
        if($headerType !== '') {
            switch($headerType) {
                ...
                case 'header-full-screen':
                    ...
                    break;
                case 'header-block':
                    $this->headerObject = new Types\HeaderBlock();
                    break;
                default:
                    break;
            }

<?php
use TargetQodef\Modules\Header\Lib;

if(!function_exists('target_qodef_set_header_object')) {
    function target_qodef_set_header_object() {
    ...
    add_action('wp', 'target_qodef_set_header_object', 1);
}
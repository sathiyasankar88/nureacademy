...
if(!function_exists('target_qodef_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function target_qodef_get_wpml_pages_for_current_page() {
...
if(!function_exists('target_qodef_disable_wpml_css')) {
    function target_qodef_disable_wpml_css() {
	    define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
    }

	add_action('after_setup_theme', 'target_qodef_disable_wpml_css');
}
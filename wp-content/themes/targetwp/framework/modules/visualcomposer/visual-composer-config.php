...
if ( ! function_exists('target_qodef_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function target_qodef_configure_visual_composer() {
	...
	add_action('vc_after_init', 'target_qodef_configure_visual_composer');

}


if ( ! function_exists('target_qodef_configure_visual_composer_grid_elemets') ) {
	...
	function target_qodef_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'target_qodef_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('target_qodef_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function target_qodef_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'target_qodef_configure_visual_composer_frontend_editor');
}
...
/*** Row ***/
if ( ! function_exists('target_qodef_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function target_qodef_vc_row_map()
	{

		$animations = array(
			'No animation' => '',
			esc_html__('Elements Shows From Left Side' , 'targetwp')	=>	'qodef-element-from-left',
			esc_html__('Elements Shows From Right Side', 'targetwp')	=> 	'qodef-element-from-right',
			esc_html__('Elements Shows From Top Side', 'targetwp')		=>	'qodef-element-from-top',
			esc_html__('Elements Shows From Bottom Side', 'targetwp')	=>	'qodef-element-from-bottom',
			esc_html__('Elements Shows From Fade'	, 'targetwp')		=>	'qodef-element-from-fade'
		);

		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Row Type', 'targetwp'),
			'param_name' => 'row_type',
			'value' => array(
				esc_html__('Row', 'targetwp') => 'row',
				esc_html__('Parallax', 'targetwp') => 'parallax'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Content Width', 'targetwp'),
			'param_name' => 'content_width',
			'value' => array(
				esc_html__('Full Width', 'targetwp') => 'full-width',
				esc_html__('In Grid', 'targetwp') => 'grid'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Header Style', 'targetwp'),
			'param_name' => 'header_style',
			'value' => array(
				esc_html__('Default', 'targetwp') => '',
				esc_html__('Light', 'targetwp') => 'qodef-light-header',
				esc_html__('Dark', 'targetwp') => 'qodef-dark-header'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Anchor ID', 'targetwp'),
			'param_name' => 'anchor',
			'value' => '',
			'description' => esc_html__('For example "home"' , 'targetwp'),
		));
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Content Aligment', 'targetwp'),
			'param_name' => 'content_aligment',
			'value' => array(
				esc_html__('Left', 'targetwp') => 'left',
				esc_html__('Center', 'targetwp') => 'center',
				esc_html__('Right', 'targetwp') => 'right'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Video Background', 'targetwp'),
			'value' => array(
				esc_html__('No', 'targetwp') => '',
				esc_html__('Yes', 'targetwp') => 'show_video'
			),
			'param_name' => 'video',
			'description' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Video Overlay', 'targetwp'),
			'value' => array(
				esc_html__('No', 'targetwp') => '',
				esc_html__('Yes', 'targetwp') => 'show_video_overlay'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Video Overlay Image (pattern)', 'targetwp'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (webm) File URL', 'targetwp'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (mp4) file URL', 'targetwp'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (ogv) file URL', 'targetwp'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' =>esc_html__( 'Video Preview Image', 'targetwp'),
			'value' => '',
		...
		vc_add_param("vc_row", array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Full Screen Height', 'targetwp'),
			'param_name' => 'full_screen_section_height',
			'value' => array(
				esc_html__('No', 'targetwp') => 'no',
				esc_html__('Yes', 'targetwp') => 'yes'
			),
			'save_always' => true
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' =>esc_html__( 'Vertically Align Content In Middle', 'targetwp'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' =>esc_html__( 'Section Height', 'targetwp'),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Parallax Background image', 'targetwp'),
			'value' => '',
			'param_name' => esc_html__('parallax_background_image', 'targetwp'),
			'description' => esc_html__('Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'targetwp'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Parallax speed', 'targetwp'),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('CSS Animation', 'targetwp'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Transition delay (ms)', 'targetwp'),
        ...
        if(target_qodef_is_live_search_installed()) {
            vc_add_param('vc_wp_search', array(
                'type' => 'dropdown',
                'class' => '',
                'heading' => esc_html__('Enable Live Search', 'targetwp'),
	...
	add_action('vc_after_init', 'target_qodef_vc_row_map');
}

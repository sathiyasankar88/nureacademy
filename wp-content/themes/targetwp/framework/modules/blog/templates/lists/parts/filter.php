<?php
$filter = esc_attr(target_qodef_options()->getOptionValue('masonry_filter'));

if($filter == 'yes'){
	$page_category = get_post_meta(target_qodef_get_page_id(), "qodef_blog_category_meta", true);
	if(is_category()){
	...
	if (count($categories) > 0) {	?>
		<div class="qodef-filter-blog-holder">
			<div class="qodef-filter-blog">
				<ul>
					<li class="qodef-filter qodef-active" data-filter="*"><span><?php esc_html_e('All', 'targetwp'); ?></span></li>

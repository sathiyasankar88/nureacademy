...
if(!function_exists('target_qodef_title_classes')) {
    /**
     * Function that adds classes to title div.
     * All other functions are tied to it with add_filter function
     * @param array $classes array of classes
     */
    function target_qodef_title_classes($classes = array()) {
        $classes = array();
        $classes = apply_filters('target_qodef_title_classes', $classes);
...
if(!function_exists('target_qodef_title_type_class')) {
    /**
     ...
     */
    function target_qodef_title_type_class($classes) {
    ...
    add_filter('target_qodef_title_classes', 'target_qodef_title_type_class');
}

if(!function_exists('target_qodef_title_background_image_classes')) {
    function target_qodef_title_background_image_classes($classes) {
        //init variables
        $id                         = target_qodef_get_page_id();
        $is_img_responsive 		    = '';
        $is_image_parallax		    = '';
        ...
        if(($meta_temp = get_post_meta($id, "qodef_title_area_background_image_meta", true)) != ""){
            ...
            $title_img = target_qodef_options()->getOptionValue('title_area_background_image');
        }
        ...
        if(($meta_temp = get_post_meta($id, "qodef_title_area_background_image_parallax_meta", true)) != ""){
            ...
            $is_image_parallax = target_qodef_options()->getOptionValue('title_area_background_image_parallax');
        }
    ...
    add_filter('target_qodef_title_classes', 'target_qodef_title_background_image_classes');
}

if(!function_exists('target_qodef_title_content_alignment_class')) {
    /**
     ...
     * @return array changed array of classes
     */
    function target_qodef_title_content_alignment_class($classes) {
        ...
        if(($meta_temp = get_post_meta($id, "qodef_title_area_content_alignment_meta", true)) != "") {
            ...
            $title_content_alignment = target_qodef_options()->getOptionValue('title_area_content_alignment');
        }
    ...
    add_filter('target_qodef_title_classes', 'target_qodef_title_content_alignment_class');
}

if(!function_exists('target_qodef_title_animation_class')) {
    /**
     * Function that adds class on title based on title animation option
     * @param $classes original array of classes
     * @return array changed array of classes
     */
    function target_qodef_title_animation_class($classes) {
        ...
        if(($meta_temp = get_post_meta($id, "qodef_title_area_animation_meta", true)) !== "") {
            ...
            $title_animation = target_qodef_options()->getOptionValue('title_area_animation');
        }
    ...
    add_filter('target_qodef_title_classes', 'target_qodef_title_animation_class');
}

if(!function_exists('target_qodef_title_background_image_div_classes')) {
    function target_qodef_title_background_image_div_classes($classes) {
    ...
    add_filter('target_qodef_title_classes', 'target_qodef_title_background_image_div_classes');
}
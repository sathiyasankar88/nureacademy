...
if ( ! function_exists('target_qodef_title_options_map') ) {

	function target_qodef_title_options_map() {
		...
		$panel_title = target_qodef_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'targetwp')
			)
		);
		...
		target_qodef_add_admin_field(
			array(
				...
				'description' => esc_html__('This option will enable/disable Title Area', 'targetwp'),
				'parent' => $panel_title,
				'args' => array(
					"dependence" => true,
		...
		$show_title_area_container = target_qodef_add_admin_container(
			array(
				'parent' => $panel_title,
		...
		$title_area_type_container = target_qodef_add_admin_container(
			array(
				'parent' => $show_title_area_container,
		...
		$title_area_background_image_responsive_container = target_qodef_add_admin_container(
			array(
				'parent' => $show_title_area_container,
		...
		$panel_typography = target_qodef_add_admin_panel(
			array(
				'page' => '_title_page',
		...
		$group_page_title_styles = target_qodef_add_admin_group(array(
			'name'			=> 'group_page_title_styles',
			'title'			=> esc_html__('Title', 'targetwp'),
			'description'	=> esc_html__('Define styles for page title', 'targetwp'),
			'parent'		=> $panel_typography
		));

		$row_page_title_styles_1 = target_qodef_add_admin_row(array(
		...
		$row_page_title_styles_2 = target_qodef_add_admin_row(array(
		...
		$group_page_subtitle_styles = target_qodef_add_admin_group(array(
			'name'			=> 'group_page_subtitle_styles',
			'title'			=> esc_html__('Subtitle', 'targetwp'),
			'description'	=> esc_html__('Define styles for page subtitle', 'targetwp'),
			'parent'		=> $panel_typography
		));

		$row_page_subtitle_styles_1 = target_qodef_add_admin_row(array(
		...
		$row_page_subtitle_styles_2 = target_qodef_add_admin_row(array(
		...
		$group_page_breadcrumbs_styles = target_qodef_add_admin_group(array(
			'name'			=> 'group_page_breadcrumbs_styles',
			'title'			=> esc_html__('Breadcrumbs', 'targetwp'),
			'description'	=> esc_html__('Define styles for page breadcrumbs', 'targetwp'),
			'parent'		=> $panel_typography
		));

		$row_page_breadcrumbs_styles_1 = target_qodef_add_admin_row(array(
		...
		$row_page_breadcrumbs_styles_2 = target_qodef_add_admin_row(array(
		...
		$row_page_breadcrumbs_styles_3 = target_qodef_add_admin_row(array(
		...
		$group_page_title_separator_styles = target_qodef_add_admin_group(array(
			'name'			=> 'group_page_separator_style',
			'title'			=> esc_html__('Separator', 'targetwp'),
			'description'	=> esc_html__('Choose color title separator', 'targetwp'),
			'parent'		=> $panel_typography
		));

		target_qodef_add_admin_field(array(
			'type'			=> 'colorsimple',
			'name'			=> 'page_separator_color',
			'default_value'	=> '',
	...
	add_action( 'target_qodef_options_map', 'target_qodef_title_options_map',6);

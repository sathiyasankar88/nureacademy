...
if ( ! function_exists('target_qodef_contact_form_7_options_map') ) {

	function target_qodef_contact_form_7_options_map() {

		target_qodef_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'targetwp'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = target_qodef_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'targetwp')
		));

		//Text Typography

		$typography_text_group = target_qodef_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'targetwp'),
			'description'	=> esc_html__('Setup typography for form elements text', 'targetwp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = target_qodef_add_admin_row(array(
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'targetwp'),
		));
		...
		$typography_text_row2 = target_qodef_add_admin_row(array(
		...
		$typography_text_row3 = target_qodef_add_admin_row(array(
		...
		$typography_label_group = target_qodef_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'targetwp'),
			'description'	=> esc_html__('Setup typography for form elements label', 'targetwp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = target_qodef_add_admin_row(array(
		...
		$typography_label_row2 = target_qodef_add_admin_row(array(
		...
		$background_border_group = target_qodef_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'targetwp'),
			'description'	=> esc_html__('Setup form elements background and border style', 'targetwp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = target_qodef_add_admin_row(array(
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'targetwp')
		));
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'targetwp')
		));

		$background_border_row2 = target_qodef_add_admin_row(array(
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'targetwp')
		));
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'targetwp')
		));

		$background_border_row3 = target_qodef_add_admin_row(array(
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'targetwp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'targetwp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));

        $background_border_row4 = target_qodef_add_admin_row(array(
        ...
        target_qodef_add_admin_field(array(
            ...
            'type'			=> 'colorsimple',
            'name'			=> 'cf7_style_1_border_bottom_color',
            'default_value'	=> '',
        ...
        target_qodef_add_admin_field(array(
            'parent'		=> $background_border_row4,
            'type'			=> 'textsimple',
            'name'			=> 'cf7_style_1_border_bottom_width',
            'default_value'	=> '',
            'label'			=> esc_html__('Border Bottom Width', 'targetwp'),
            'args'			=> array(
                'suffix' => 'px'
            )
        ));
		...
		$padding_group = target_qodef_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'targetwp'),
			'description'	=> esc_html__('Setup form elements padding', 'targetwp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = target_qodef_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'targetwp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'targetwp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = target_qodef_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'targetwp'),
			'description'	=> esc_html__('Setup form elements margin', 'targetwp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = target_qodef_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Margin Top', 'targetwp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Margin Bottom', 'targetwp'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'targetwp'),
			'description'	=> esc_html__('Enter height for textarea form element', 'targetwp'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = target_qodef_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'targetwp'),
			'description'	=> esc_html__('Setup button text typography', 'targetwp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = target_qodef_add_admin_row(array(
		...
		$button_typography_row2 = target_qodef_add_admin_row(array(
		...
		$button_background_border_group = target_qodef_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'targetwp'),
			'description'	=> esc_html__('Setup button background and border style', 'targetwp'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = target_qodef_add_admin_row(array(
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'targetwp'),
		));

		$button_background_border_row2 = target_qodef_add_admin_row(array(
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'targetwp')
		));
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'targetwp')
		));

		$button_background_border_row3 = target_qodef_add_admin_row(array(
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'targetwp'),
			'description'	=> esc_html__('Insert form button height', 'targetwp'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'targetwp'),
			'description'	=> esc_html__('Enter value for button left and right padding', 'targetwp'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = target_qodef_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2','targetwp')
		));
        ...
        target_qodef_add_admin_field(array(
            'parent'		=> $background_border_row4,
            'type'			=> 'colorsimple',
            'name'			=> 'cf7_style_2_border_bottom_color',
            'default_value'	=> '',
            'label'			=> esc_html__('Border Bottom Color', 'targetwp')
        ));
        ...
        target_qodef_add_admin_field(array(
            'parent'		=> $background_border_row4,
            'type'			=> 'textsimple',
            'name'			=> 'cf7_style_2_border_bottom_width',
            'default_value'	=> '',
            'label'			=> esc_html__('Border Bottom Width', 'targetwp'),
            'args'			=> array(
                'suffix' => 'px'
	...
	add_action( 'target_qodef_options_map', 'target_qodef_contact_form_7_options_map',10);

...
add_action('after_setup_theme', 'target_qodef_admin_map_init', 0);

function target_qodef_admin_map_init() {

    do_action('target_qodef_before_options_map');
    ...
    do_action('target_qodef_options_map');

    do_action('target_qodef_after_options_map');

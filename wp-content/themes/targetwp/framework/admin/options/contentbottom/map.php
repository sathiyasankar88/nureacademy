...
if ( ! function_exists('target_qodef_content_bottom_options_map') ) {

	function target_qodef_content_bottom_options_map() {
		...
		$panel_content_bottom = target_qodef_add_admin_panel(
			array(
				'page'  => '_content_bottom_page',
				'name'  => 'panel_content_bottom',
				'title' => esc_html__('Content Bottom Area', 'targetwp')
			)
		);
		...
		$enable_content_bottom_area_container = target_qodef_add_admin_container(
			array(
				'parent'            => $panel_content_bottom,
		...
		target_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Widget Area to Display', 'targetwp'),
			'description'	=> esc_html__('Choose a Content Bottom widget area to display', 'targetwp'),
	...
	add_action( 'target_qodef_options_map', 'target_qodef_content_bottom_options_map',20);

...
class SelectSkin extends TargetQodefSkinAbstract {
    /**
     * Skin constructor. Hooks to target_qodef_admin_scripts_init and target_qodef_enqueue_admin_styles
     */
	public function __construct() {
		$this->skinName = 'select';

        //hook to admin register scripts
        add_action('target_qodef_admin_scripts_init', array($this, 'registerStyles'));
        add_action('target_qodef_admin_scripts_init', array($this, 'registerScripts'));

        //hook to admin enqueue scripts
        add_action('target_qodef_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('target_qodef_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('target_qodef_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('target_qodef_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            target_qodef_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            target_qodef_register_skin_style($styleHandle, $stylePath);
        }
	...
	public function setIcons() {
        ...
        $icons_array = apply_filters('target_qodef_set_skin_icons', $icons_array, $this->getSkinURI() . '/');
	...
	public function setMenuItemPosition() {
        ...
        $positions_array = apply_filters('target_qodef_set_skin_menu_positions', $positions_array);
	...
	public function renderOptions() {
        ...
        $tab    = target_qodef_get_admin_tab();
        $active_page = $target_qodef_Framework->qodeOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param TargetQodefAdminPage $page current page to load
     *
     * @see QodeSkinAbstract::loadTemplatePart()
     */

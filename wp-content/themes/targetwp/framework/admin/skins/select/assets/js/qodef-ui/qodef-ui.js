(function ($) {
        ...
        wp.media.customlibEditGallery1 = {
            ...
            frame: function () {
                ...
                this._frame.on('update', function () {
                    ...
                    var data = {
                        action: 'target_qodef_gallery_upload_get_images',
                        ids: ids,
                        post_name: $input_gallery_items.attr('name'),
                        upload_gallery_nonce: $('#target-qode-update-images_' + $input_gallery_items.attr('name')).val()
                    }
    ...
    function qodefInitAjaxForm() {
        ...
        $(document).delegate(".qode_ajax_form", "submit", function (a) {
            var b = $(this);
            var c = {
                action: "target_qodef_save_options"
            };
            jQuery.ajax({
                url: ajaxurl,
                cache: !1,
